...
export default function SectionTitle({ number, title }: Props) {
  return (
    <div className='flex w-full items-center justify-center py-4 after:relative after:ml-4 after:block after:h-[1px] after:w-full after:bg-accent after:content-[""]'>
