    ...
    >
      ...
      <div className='flex flex-col gap-6 text-left'>
        ...
        <Button
          ...
          variant='outline'
          className='relative w-fit animate-[fadeIn_1s_forwards_2500ms] gap-2 bg-inherit font-secondary opacity-0 hover:bg-accent hover:text-secondary active:top-1'
        >
